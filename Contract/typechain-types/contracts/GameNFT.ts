...
export interface GameNFTInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getKeysAndValues",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface GameNFT extends BaseContract {
  ...
  getKeysAndValues: TypedContractMethod<
    [nft: BigNumberish],
    [[string[], bigint[]] & { k: string[]; v: bigint[] }],
    "view"
  >;
  ...
  updateMetadata: TypedContractMethod<
    [nft: BigNumberish, k: string[], v: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "getKeysAndValues"
  ): TypedContractMethod<
    [nft: BigNumberish],
    [[string[], bigint[]] & { k: string[]; v: bigint[] }],
    "view"
